...
ENT.PrintName = "2018 Ford F150 Police Responder"
ENT.Author = "mighters"
ENT.Information = ""
...
ENT.MDL = "models/smcars/lvs_ford_police_responder.mdl"
...
ENT.TransGears = 10 -- amount of gears in forward direction. NOTE: the engine sound system calculates the  gear ratios based on topspeed and amount of gears. This can not be changed.
...
ENT.TransShiftSpeed = 0.2 -- in seconds. How fast the transmission handles a shift. The transmission mimics a manual shift by applying clutch, letting off throttle, releasing clutch and applying throttle again even tho it is automatic.
ENT.TransWobble = 1 -- basically how much "play" is in the drivedrain. 
ENT.TransWobbleTime = 0.1 -- in seconds. How long after a shift or after applying throttle the engine will wobble up and down in rpm
